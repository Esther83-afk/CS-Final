...
public class DriverLinkedListAPIAdd {
    ...
    public void runIntegerInsertionTest(String insertionLocation,int sizeOfList){
        ...
        for (int r = 0; r < numberOfRuns; r++) {
            ...
            System.out.println("Insertion Integers at " + insertionLocation + " of LinkedListAPI with size of " + sizeOfList + " Run " + r + " Total Time: " + total + " ns");
    ...
    public void runDoubleInsertionTest(String insertionLocation, int sizeOfList){
        ...
        for (int r = 0; r < numberOfRuns; r++) {
            ...
            total = (System.nanoTime() - start);
            addTotal=total+addTotal;
            System.out.println("Insertion of Doubles at " + insertionLocation + " of LinkedListAPI with size of " + sizeOfList + " Run " + r + " Total Time: " + total + " ns");
    ...
    public static void main(String[] args) {
        ...
        //10000
        DriverLinkedListAPIAdd testIntList = new DriverLinkedListAPIAdd();
        ...
        DriverLinkedListAPIAdd testDoubleList = new DriverLinkedListAPIAdd();
